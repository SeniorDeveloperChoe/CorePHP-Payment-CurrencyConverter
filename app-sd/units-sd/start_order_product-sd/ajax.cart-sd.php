<?php
   ...
   if($action=="getSupplierDetail" && !empty($supplierid)){
   		...
   		$return_array=$db->pdoQuery("SELECT c.location,c.company_name,c.country_code_1,c.contact_no_1,c.contact_person_name,CONCAT(u.first_name,' ',u.last_name) AS supplierName
      ...
      $file_array = array(
         ...
         $data=parse_str($_POST['cartData'], $params);
         echo "<pre>";
         print_r($params);
         exit();
   }
